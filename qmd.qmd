...
# exp_coef <- exp(modelo_logit_3$coefficients)
...
# x$coefficients[1:9,2] 
# colnames(x$cov.unscaled)
x$cov.unscaled[1,1]
```
...
x$cov.unscaled["proposed_credit_limit","proposed_credit_limit"]
colnames(x$cov.unscaled)
```
...
- 2 emails registados en la página del banco en las últimas 8 semanas
...
- Un solo email registado en la página del banco en las últimas 8 semanas
